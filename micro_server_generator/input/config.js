...
const description = 'ElbrusStonks is a NFT Collection';
...
addRarityPercentForLayer('common', 'Layer1', prectntages);
...
addRarityPercentForLayer('common', 'Layer2', prectntages);
...
addRarityPercentForLayer('common', 'layer3', prectntages);
...
addRarityPercentForLayer('common', 'Layer4', prectntages);
...
addRarityPercentForLayer('common', 'Layer5', prectntages);
...
addRarityPercentForLayer('common', 'Layer6', prectntages);
...
addRarityPercentForLayer('common', 'Layer7', prectntages);
...
addRarityPercentForLayer('common', 'Layer8', prectntages);
...
addRarityPercentForLayer('common', 'Layer9', prectntages);
